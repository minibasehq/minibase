...
Minibase is a lightweight **application backend** with a Postgres base and an API gateway middleware layer of services that can be added and swapped out as needed.
